...
const siteconfig = {
    create: async (data) => {
        const sql = `INSERT INTO siteconfig
            (siteName, clientUrl, logo, whiteLogo, icon, instagramURL, facebookURL, twitterURL,
             linkedInURL, youtubeURL, mobile, email, currency, deliveryCharge, primaryColor, marqueeItems, metaPixelId,
    ...
    update: async (id, data) => {
        const sqlUpdate = `UPDATE siteconfig SET
            ...
            mobile=?, email=?, currency=?, deliveryCharge=?, primaryColor=?, marqueeItems=?, metaPixelId=?,
